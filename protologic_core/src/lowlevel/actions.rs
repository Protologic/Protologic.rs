...
extern
{
    ...
    pub fn gun0_set_elevation(bearing: f32);

    /// Set the fuse of shells fire from gun 0
    pub fn gun0_set_fuse(bearing: f32);
    ...
    pub fn gun1_set_elevation(bearing: f32);

    /// Set the fuse of shells fire from gun 1
    pub fn gun1_set_fuse(bearing: f32);
    ...
    pub fn gun2_set_elevation(bearing: f32);

    /// Set the fuse of shells fire from gun 2
    pub fn gun2_set_fuse(bearing: f32);
    ...
    pub fn gun3_set_elevation(bearing: f32);

    /// Set the fuse of shells fire from gun 3
    pub fn gun3_set_fuse(bearing: f32);
